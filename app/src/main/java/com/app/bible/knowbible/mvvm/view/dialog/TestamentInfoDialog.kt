...
class TestamentInfoDialog(private val listener: DialogListener) : AppCompatDialogFragment() {
    lateinit var testamentInfoText: String
    var testamentInfoIconRes: Int = -1
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view: View = inflater.inflate(R.layout.dialog_testament_info, null)
        ...
        val testamentIcon: ImageView = view.findViewById(R.id.testamentIcon)
        testamentIcon.setImageResource(testamentInfoIconRes)

        val tvTestamentInfo: TextView = view.findViewById(R.id.tvTestamentInfo)
        tvTestamentInfo.text = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            SpannableString(Html.fromHtml(testamentInfoText, HtmlCompat.FROM_HTML_MODE_LEGACY))
        } else {
            SpannableString(Html.fromHtml(testamentInfoText))
        }
