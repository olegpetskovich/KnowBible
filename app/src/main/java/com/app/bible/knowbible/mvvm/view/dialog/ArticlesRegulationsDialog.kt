...
class ArticlesRegulationsDialog(private val listener: DialogListener) : AppCompatDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view: View = inflater.inflate(R.layout.dialog_articles_regulations, null)
        ...
        myTextView.text = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            SpannableString(Html.fromHtml(getString(R.string.tv_articles_regulations), HtmlCompat.FROM_HTML_MODE_LEGACY))
        } else {
            SpannableString(Html.fromHtml(getString(R.string.tv_articles_regulations)))
        }
